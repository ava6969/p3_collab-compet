...
class DDPG():
    ...
    def __init__(self, state_size, action_size, random_seed, num_agents, agent_id):
    ...
    def save(self):
        torch.save(self.actor_local.state_dict(), 'actor{}.pth'.format(self.agent_id))
        torch.save(self.critic_local.state_dict(), 'critic{}.pth'.format(self.agent_id))

    def load(self):
        self.actor_local.load_state_dict(torch.load('actor{}.pth'.format(self.agent_id)))
        self.critic_local.load_state_dict(torch.load('critic{}.pth'.format(self.agent_id)))